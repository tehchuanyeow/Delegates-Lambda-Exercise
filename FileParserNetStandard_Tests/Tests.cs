...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "C:/Users/STUDENT/Desktop/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/data.csv";  // change to appropriate path
        private string _tsvPath = "C:/Users/STUDENT/Desktop/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/data.tsv";  // change to appropriate path

        private string _writeFile = "C:/Users/STUDENT/Desktop/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/dataWrite.txt";  // change to appropriate path
